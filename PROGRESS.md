...
- **最后更新**:2026-06-16 · `main` @ `ee3f7e6`(Phase 6.4b:审批弹窗,敏感命令已门控)
- **门禁**:kurt-agent **141** · kurt-tui **70** · kurt-bridge **18** · kurt-app build+**Vitest 18**+cargo ✓ · 全 typecheck 干净(GUI 人工核对 `MANUAL_TESTS §6.3/§6.4b`)
...
| 6.4c | API key 设置(Settings → Keychain)、模型/effort 菜单驱动真实 per-run config、真实文件预览 | ⬜ 下一步 |
