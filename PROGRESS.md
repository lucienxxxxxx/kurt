...
- **最后更新**:2026-06-17 · `main` @ `39436d7`(会话删除:侧栏…菜单两步确认删除,接 bridge DELETE;前置 `f94614f` 消息操作/回退)
- **门禁**:kurt-agent **150** · kurt-tui **70** · kurt-bridge **24** · kurt-app build+**Vitest 36**+cargo ✓ · 全 typecheck 干净(GUI 人工核对 `MANUAL_TESTS §6.3–§6.4`)
