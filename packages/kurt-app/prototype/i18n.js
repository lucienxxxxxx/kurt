// ===== window.T  +  window.tr(entry, lang, params?) =====
(function () {
  // helper to pick string from a {zh,en} entry, or pass-through plain string
  window.tr = function (entry, lang, params) {
    if (entry == null) return "";
    let v;
    if (typeof entry === "string") v = entry;
    else v = entry[lang] || entry.zh || entry.en || "";
  ...
  window.T = {
    ...
    // profile
    proHint:     { zh: "Pro · 点击切换{theme}", en: "Pro · Click for {theme} mode" },
    ...
    toggleLang:  { zh: "切换语言", en: "Switch language" },
    ...
    skillLabel:  { zh: "技能调用", en: "Skill invocation" },
    // composer
    ...
    queuedDesc:  { zh: "将在当前任务结束后自动发送", en: "Will be sent after the current task finishes" },
    ...
    filePreview:      { zh: "文件预览", en: "File Preview" },
    ...
    generalSoon:     { zh: "更多通用设置即将推出。", en: "More general settings coming soon." },
